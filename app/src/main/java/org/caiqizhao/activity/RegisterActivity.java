        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.return_login:
                    //摧毁本活动返回登陆界面
                    intent = new Intent(RegisterActivity.this, Main.class);
                ...
                case R.id.go_register:
                    ...
                    if (uername.getText().toString().equals("")){
                        ToastUtil.showToast(RegisterActivity.this,"账户不能为空");
                        verify.setImageBitmap(VerityCode.getInstance().createBitmap());
                        return;
                    }
                        ...
                        if(UsernameAndPasswordByIs.checkPassword(password.getText().toString())){
                            if(password.getText().toString().equals(again_password.getText().toString())){
                                if(verify_on.getText().toString().toLowerCase()
                                    ...
                                    //启动服务向服务器发送请求验证注册信息
                                    intent = new Intent(RegisterActivity.this,RegisterService.class);
                                    ...
                                    ToastUtil.showToast(RegisterActivity.this,"请输入正确的验证码");
                            ...
                            ToastUtil.showToast(RegisterActivity.this,"密码格式不正确");
                            verify.setImageBitmap(VerityCode.getInstance().createBitmap());
                        }
                    }else {
                        ToastUtil.showToast(RegisterActivity.this,"账户格式不正确");
                        verify.setImageBitmap(VerityCode.getInstance().createBitmap());
                    }
                    break;
                case R.id.verify:
